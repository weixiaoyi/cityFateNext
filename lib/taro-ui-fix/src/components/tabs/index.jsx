...
export default class AtTabs extends AtComponent {
    ...
    render() {
        ...
        const tabItems = tabList.map((item, idx) => {
            ...
            return <View className={itemCls} id={`tab${this._tabId}${idx}`} key={item.title} onClick={this.handleClick.bind(this, idx)}>
        {item.title}
        ...
        {scroll
            ? <ScrollView id={this._tabId} className='at-tabs__header' style={heightStyle} scrollX={scrollX} scrollY={scrollY} scrollWithAnimation scrollLeft={_scrollLeft} scrollTop={_scrollTop} scrollIntoView={_scrollIntoView}>
              {tabItems}
            </ScrollView>
